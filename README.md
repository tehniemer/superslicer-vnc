...
If you're using unraid, open your Docker page and under `Template repositories`, add `https://github.com/helfrichmichael/unraid-templates` and save it. You should then be able to Add Container for superslicer-vnc. For unraid, the template will default to 6080 for the noVNC web instance.
...
--name=superslicer-vnc mikeah/superslicer-vnc`
...
[Superslicer](https://superslicer.org)
